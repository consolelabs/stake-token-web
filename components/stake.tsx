...
export const Stake = (props: Props) => {
  ...
  return (
    <div className="pt-6 pb-16 px-8 grid grid-cols-1 lg:grid-cols-[1fr,minmax(auto,512px),1fr] overflow-y-auto h-[calc(100vh-56px)]">
      <div className="lg:col-start-2 w-full max-w-lg mx-auto flex flex-col space-y-4">
        <Link href={ROUTES.OVERVIEW} className="flex items-center space-x-2">
